...
class EditAlbumScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final album = ref.read(albumByIdProvider(albumId))!;

    final formKey = GlobalKey<FormState>();
    final tituloController = TextEditingController(text: album.titulo);
    final artistaController = TextEditingController(text: album.artista);
    final descripcionController = TextEditingController(text: album.descripcion);
    final adicionalController = TextEditingController(text: album.adicional);
    final yearController = TextEditingController(text: album.year.toString());
    final tapaUrlController = TextEditingController(text: album.tapaUrl);

    return Scaffold(
      appBar: AppBar(title: Text('Editar álbum', style: GoogleFonts.specialElite())),
      body: Padding(

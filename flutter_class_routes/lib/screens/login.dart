...
import 'package:flutter_application_1/entities.dart';
...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  String? validarMail(String? text) {
    if (text == null || text.isEmpty) {
      return 'Ingrese su mail';
    }
    if (text != testLogin.mail) {
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Text('Ingrese su mail:'),
              TextFormField(
                controller: _mailController,
                validator: validarMail,//llama la validacion. el campo textformfield tiene el parametro de validator y dentro de ese va la validacion que le hagas
              ),
